...
@Module({
    ...
    providers: [ShortenUrlService, ListMyUrlsService, UpdateUrlService, RedirectUrlService],
    exports: [ShortenUrlService, ListMyUrlsService, UpdateUrlService, RedirectUrlService]
})
